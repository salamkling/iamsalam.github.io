        ...
        <div class="col-md-8 p-3">
          ...
          <div class="row">
            <div class="row p-3 mb-2">
              <img class="img-fluid" src="images/scholar.png">
            </div>
          ...
          <div class="row">
            ...
            <div class="card-header text-white" style="background: #1c3b22;"><h4 style="text-transform: uppercase;">University Sponsored Scholarship</h4></div>
            <div class="card-body">
                  <ol class="card-text" style="padding-left: 20px; padding-bottom: 8px;">
                 <li>Entrance Scholarship </li>
                 <li>University Scholarship </li>
                 <li>College Scholarship</li>
                 <li>Athletes Assistance </li>
                 <li>Student Publication </li>
                 <li>Socio-Cultural Scholarship </li>
                 <li>SSC / Student Organization Scholarship </li>
                </ol>
            </div>
          </div>
          </div>
            ...
            <div class="row">
            <div class="card text-dark mb-3" style="max-width: 100rem;">
            <div class="card-header text-white" style="background: #1c3b22;"><h4 style="text-transform: uppercase;">Government Sponsored Scholarship</h4></div>
            <div class="card-body">
              <ol class="card-text" style="padding-left: 20px; padding-bottom: 8px;">
              <li>NSDY</li>
                 <li>LPGMA</li>
                 <li>Ched - Financial Assistance</li>
                 <li>Tertiary Education Subsidy</li>
                 <li>Universal Access to Quality - Tertiary Education (RA 10931)</li>
                 <li>DA - ACEF - GIAHEF</li>
                 <li>Municipal Government Scholarship</li>
                 <li>Provincial Scholarship Program - BRO for Education</li>
            </ol>
            </div>
          </div>
          </div>
