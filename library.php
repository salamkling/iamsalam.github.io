  ...
  <div class="p-5">
    <div class="container-fluid mb-2">
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="row mb-3">
            <h2 class="text-white p-3"  style="background: #093b24;  font-family: Arial, Helvetica, sans-serif;">LIBRARY ORGANIZATION STRUCTURE</h2>
          </div>
           <div class="row" align="center">
              <a href="images/26.jpg"><img src="images/26.jpg" class="img-thumbnail bg-white shadow-lg p-2" width="500" height="500" ></a> 
            </div>
        </div>
      </div>
