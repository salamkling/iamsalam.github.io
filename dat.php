          ...
          <div class="row">
            <div class="col-md-5 pt-2 pb-5" >
              ...
              <thead class="text-white border">
                <tr class="border">
                  <th colspan="2" scope="col">DAT OFFICERS</th>
                </tr>
              </thead>
                 <tbody style="font-weight: bold;">
              <?php 
            include "connection.php";
            $sql = "SELECT * FROM tbl_dat ORDER BY id DESC LIMIT 1";
            ...
            <tr>
              ...
              <td><?php echo $row["isec"]; ?></td>
            </tr>
             <tr>
               <td>EXTERNAL SECRETARY</td>
              <td><?php echo $row["esec"]; ?></td>
            </tr>
            <tr>
               <td>TREASURER</td>
            ...
            <div class="slide" align="center">
              <div class="w3-content w3-section p-2">
                <div class="row mb-3 text-white" style="background: #1b573d;">
                  <h3 class="p-2">DAT ACTIVITIES</h3>
                </div>
                <div class="row shadow-lg rounded">
                <img src="Dat/1.jpg" class="mySlides" alt="Responsive image" width="85%">
                <img src="Dat/2.jpg" class="mySlides" alt="Responsive image" width="85%">
                <img src="DAT/3.jpg" class="mySlides" alt="Responsive image" width="85%">
                <img src="DAT/4.jpg" class="mySlides" alt="Responsive image" width="85%">
                <img src="DAT/5.jpg" class="mySlides" alt="Responsive image" width="85%">
                <img src="DAT/6.jpg" class="mySlides" alt="Responsive image" width="85%">
                <img src="DAT/7.jpg" class="mySlides" alt="Responsive image" width="85%">
                <img src="DAT/8.jpg" class="mySlides" alt="Responsive image" width="85%">
                <img src="DAT/9.jpg" class="mySlides" alt="Responsive image" width="85%">
                <img src="DAT/DAT.jpg" class="mySlides" alt="Responsive image" width="85%">
                </div>
      ...
      <div class="container text-center text-md-start mt-5">
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
            ...
            <p>
               <a class="text-white" target="_blank" href="https://www.facebook.com/ISUsmDAT/" style="text-decoration: none;"><i class="fa fa-facebook"></i> Supreme Student Council</a>
            </p>
            <p>
