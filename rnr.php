    ...
    <div class="container-fluid mb-2">
      ...
      <div class="row">
        <div class="col-md-3 mb-3">
          <h4 class="p-3 text-white" style="background: #093b24;">LIBRARY MENU</h4>
          <div class="vertical-menu" align="center">
            <a class="border btn" href="library.php">ORGANIZATION CHART</a>
            <a class="border btn" href="rnr.php">RULES AND REGULATIONS</a>
            <a class="border btn" href="lcc.php">CITIZEN CHARTER</a>
            <a class="border btn" href="sej.php">SUBSCRIBE E-JOURNALS</a>
            <a class="border btn" href="seb.php">SUBRICIBE E-BOOKS</a>
          </div>
        </div>
        <div class="col-md-9">
          <div class="row mb-3">
            <h2 class="text-white p-3"  style="background: #093b24;  font-family: Arial, Helvetica, sans-serif;">RULES AND REGULATIONS</h2>
          </div>
           <div class="row p-3 shadow">
            <div class="embed-responsive embed-responsive-16by9">
            <iframe class="embed-responsive-item" src="pdf/LIBRARY-RULES-AND-REGULATIONS.pdf" allowfullscreen style="width:100%; height: 1000px;"></iframe>
          </div>
           </div>
        </div>
      </div>
      ...
      <div class="container text-center text-md-start mt-5">
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
            ...
            <hr class="mb-4 mt-0 d-inline-block mx-auto" style="widtd: 60px; background-color: green; height: 2px"
                />
            <p>
              Altdough it is not big campus as its motder campus, it houses a family of teachers and students, who have brilliant minds and creative hands in achieving excellence in Instruction, production, research and extension. ISU San Mateo campus has gone long in its effort to work for tde betterment of tde students.
            </p>
          </div>
          <!-- Grid column -->
          ...
          <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
            ...
            <hr class="mb-4 mt-0 d-inline-block mx-auto" style="widtd: 60px; background-color: #7c4dff; height: 2px"/>
            <p>
            ...
            <p>
             <a class="text-white" style="text-decoration: none;" target="_blank" href="https://www.facebook.com/isusanmatregistrar/"><i class="fa fa-facebook"></i> Office of tde Registrar</a>
            </p>
          </div>
          <!-- Grid column -->
          ...
          <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
            ...
            <hr class="mb-4 mt-0 d-inline-block mx-auto" style="widtd: 100px; background-color: white; height: 2px"/>
