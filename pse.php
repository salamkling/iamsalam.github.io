      ...
      <div class="row">
        <div class="col-md-3 p-3">
          ...
          <div class="row mb-2">
            ...
            <a class="border brilliant" href="dat.php">DAT</a>
          ...
          <div class="row">
            <div class="col-md-5 pt-2 pb-5" >
              ...
              <thead class="text-white border">
                <tr class="border">
                  <th colspan="2" scope="col">PSE OFFICERS</th>
                </tr>
              </thead>
                 <tbody style="font-weight: bold;">
              <?php 
            include "connection.php";
            $sql = "SELECT * FROM tbl_pse ORDER BY id DESC LIMIT 1";
            ...
            <tr>
              ...
              <td><?php echo $row["msec"]; ?></td>
            </tr>
             <tr>
               <td>BOARD SECRETARY</td>
              <td><?php echo $row["bsec"]; ?></td>
            </tr>
            <tr>
               <td>TREASURER</td>
            ...
            <tr>
               <td>BSE REPRESENTATIVE</td>
              <td><?php echo $row["bse"]; ?></td>
            </tr>
            <tr>
               <td>BTTE REPRESENTATIVE</td>
              <td><?php echo $row["btte"]; ?></td>
            </tr>
            <tr>
               <td>BTVTED REPRESENTATIVE</td>
            ...
            <div class="slide" align="center">
              <div class="w3-content w3-section p-2">
                <div class="row mb-3 text-white" style="background: #1b573d;">
                  <h3 class="p-2">PSE ACTIVITIES</h3>
                </div>
                <div class="row shadow-lg rounded">
                <img src="PSE/1.jpg" class="mySlides" alt="Responsive image" width="85%">
                <img src="PSE/2.jpg" class="mySlides" alt="Responsive image" width="85%">
                <img src="PSE/3.jpg" class="mySlides" alt="Responsive image" width="85%">
                <img src="PSE/4.jpg" class="mySlides" alt="Responsive image" width="85%">
                <img src="PSE/5.jpg" class="mySlides" alt="Responsive image" width="85%">
                <img src="PSE/6.jpg" class="mySlides" alt="Responsive image" width="85%">
                <img src="PSE/7.jpg" class="mySlides" alt="Responsive image" width="85%">
                <img src="PSE/8.jpg" class="mySlides" alt="Responsive image" width="85%">
                <img src="PSE/9.jpg" class="mySlides" alt="Responsive image" width="85%">
                <img src="PSE/10.jpg" class="mySlides" alt="Responsive image" width="85%">
                <img src="PSE/11.jpg" class="mySlides" alt="Responsive image" width="85%">
                <img src="PSE/PSE.jpg" class="mySlides" alt="Responsive image" width="85%">
                </div>
