     ...
     <!---bookmark--->
            <div class="slide mb-2" align="center" style="background: #12613d;">
              <div class="w3-content w3-section">
                <img src="slide/R1.jpg" class="mySlides" alt="Responsive image">
                <img src="slide/R2.jpg" class="mySlides" alt="Responsive image">
                <img src="slide/R3.jpg" class="mySlides" alt="Responsive image">
                <img src="slide/R4.jpg" class="mySlides" alt="Responsive image">
                <img src="slide/R5.jpg" class="mySlides" alt="Responsive image">
              </div>
            </div>
            <!---bookmark--->
            ...
            <div class="container-fluid p-5">
              ...
              <thead class="text-white border">
                <tr class="border">
                  <th scope="col">Title of Researc Program/Project/Study</th>
          ...
          $getQuery = "SELECT * FROM research ORDER BY id DESC";    
          ...
          $getQuery = "SELECT * FROM research LIMIT " . $initial_page . ',' . $limit;  
