  ...
  <div class="p-5">
    <div class="container-fluid mb-2">
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="row mb-3">
            <h2 class="text-white p-3"  style="background: #093b24;  font-family: Arial, Helvetica, sans-serif;">LIBRARY CHARTER</h2>
          </div>
           <div class="row p-3 shadow">
            <div class="embed-responsive embed-responsive-16by9">
            <iframe class="embed-responsive-item" src="pdf/LIBRARY_CHARTER.pdf" allowfullscreen style="width:100%; height: 1000px;"></iframe>
          </div>
           </div>
        </div>
      </div>
