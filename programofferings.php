  ...
  <div>
    <div class="container  p-5">
      <div class="row p-5 bg-white shadow-lg">
        <div class="row">
          <div class="p-2 text-white" style="background: #093b24; font-family: 'Roboto', sans-serif;">
               <h2>COURSE OFFERINGS</h2>
            </div>
        </div>
        <div class="row">
          <div class="col-md-6">
          <p class="p-2" style="font-size: 25px; font-weight: 700;">4 Year Courses</p>
            <p class="" style="font-size: 20px; font-weight: 500;">Bachelor Of Science In Information Technology</p>
            <p class="" style="font-size: 20px; font-weight: 500;">Bachelor In Secondary Education Major In:</p>
            <p class="" style="font-size: 18px; font-weight: 400;">- Social Studies</p>
            <p class="" style="font-size: 18px; font-weight: 400;">- Mathematics</p>
             <p class="" style="font-size: 20px; font-weight: 500;">Bachelor Of Technical Vocational Teacher Education Major In:</p>
            <p class="" style="font-size: 18px; font-weight: 400;">- Garments, Fashion And Design</p>
            <p class="" style="font-size: 18px; font-weight: 400;">- Electronics Technology</p>
            <p class="" style="font-size: 18px; font-weight: 400;">- Electrical Technology</p>
            <p class="" style="font-size: 20px; font-weight: 500;">Bachelor Of Agricultural Technology</p>
        </div>
        <div class="col-md-6">
            <p class="p-2" style="font-size: 25px; font-weight: 700;">2 Year Courses</p>
             <p class="" style="font-size: 20px; font-weight: 500;">Bachelor Of Technical Teacher Education (Ladderized) Major In:</p>
            <p class="" style="font-size: 18px; font-weight: 400;">- Garments, Fashion And Design</p>
            <p class="" style="font-size: 18px; font-weight: 400;">- Electronics Technology</p>
            <p class="" style="font-size: 18px; font-weight: 400;">- Electrical Technology</p>
            <p class="" style="font-size: 20px; font-weight: 500;">Diploma in Agricultural Technology</p>
            </div>
          </div>
        </div>
