  ...
  <div>
    <div class="container-fluid">
      <div class="row p-5">
        ...
        <iframe width="100%s" height="500" class="embed-responsive-item shadow-lg p-3 bg-secondary rounded" src="https://www.youtube.com/embed/fytnHQeaHQs?autoplay=1&mute=1" allowfullscreen ></iframe>
      </div>
        </div>
   
        <div class="col-md-6 p-5">
        <h2 style="font-size: 25px; font-family: 'Roboto', sans-serif; font-size: 45px;">ISU HYMN</h2>
        <h5 style="color: darkgray;">Lyrics by: Prof. Edgardo V. Babaran and Prof. Evangeline P. Juan</h5>
        <h5 style="color: darkgray;">Music by: Mr. Constante Tabalba</h5>
        <p style="font-size: 25px;">O glorious seat of learning
          In our valley dear
          We praise her name
          Isabela State University
          With rays ever so clear</p>

        <p style="font-size: 25px;">In grateful strides we bear
        Thy standard high that to our quest
        For knowledge does strive thy Youth grow excelling
        In cities, fields, and mountain sides
        We’ll sing and cheer for our dear I.S.U.</p>

        <p style="font-size: 25px;">eloved Alma mater
