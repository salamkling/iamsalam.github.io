...
<body>
  ...
  <div class="topnavs" id="myTopnavs">
    ...
    <div class="dropdowns">
      ...
      <div class="dropdowns-content">
        <a href="sanmateocampus.php">Organizational Chart</a>
      ...
      <div class="row p-5">
        <div class="col-md-8 p-3">
          <div class="row" style="font-size: 25px;">
           <div class="row text-white p-3 mb-5" style="background: #093b24;  font-family: Arial, Helvetica, sans-serif;">
               <h1>EXTENSION AND TRAINING</h1>
            </div>
           
            <div class="row" align="center">
              <a href="images/16.jpg"><img src="images/16.jpg" class="img-thumbnail bg-white shadow-lg p-2" width="500" height="500" ></a> 
            </div>
          </div>
        </div>
