      ...
      <div class="row p-5">
        ...
        <div class="col-md-8 p-5 " style="font-weight:normal;">
          ...
          <div class="row mb-3" style="font-size: 20px;">
            ...
            <p  style="text-indent: 60px;">The Isabela State University As A Leading, Vibrant, Comprehensive And Research University In The Country And The ASEAN Region.</p>
          </div>
          ...
          <div class="row mb-3" style="font-size: 20px;">
            ...
            <p  style="text-indent: 60px;">The Isabela State University Is Committed To Develop Highly Trained And Globally Competent Professionals; Generate Innovative And Cutting-Edge Knowledge And Technologies For People Empowerment And Sustainable Development; Engage In Viable Resource Generation Programs; And Maintain And Enhance Stronger Partnership Under Good Governance To Advance The Interests Of National And International Communities.</p>
          </div>

          <div class="row" align="center">
            <a href="images/map-isabela-state-university.png"><img class="img-thumbnail p-5 bg-success" src="images/map-isabela-state-university.png" width="820" height="447"></a>
          </div>
