          ...
          <div class="row">
            <div class="col-md-5 pt-2 pb-5" >
              ...
              <thead class="text-white border">
                <tr class="border">
                  <th colspan="2" scope="col">ICTS OFFICERS</th>
                </tr>
              </thead>
                 <tbody style="font-weight: bold;">
              <?php 
            include "connection.php";
            $sql = "SELECT * FROM tbl_ict ORDER BY id DESC LIMIT 1";
            ...
            <tr>
              ...
              <td><?php echo $row["frep"]; ?></td>
            </tr>
            <tr>
               <td>2ND YEAR REPRESENTATIVE</td>
              <td><?php echo $row["srep"]; ?></td>
            </tr>
             <tr>
               <td>3RD YEAR REPRESENTATIVE</td>
              <td><?php echo $row["trep"]; ?></td>
            </tr>
             <tr>
               <td>4TH YEAR REPRESENTATIVE</td>
              <td><?php echo $row["ftrep"]; ?></td>
            </tr>
            ...
            <div class="slide" align="center">
              <div class="w3-content w3-section p-2">
                <div class="row mb-3 text-white" style="background: #1b573d;">
                  <h3 class="p-2">ICTS ACTIVITIES</h3>
                </div>
                <div class="row shadow-lg rounded">
                <img src="IT/1.jpg" class="mySlides" alt="Responsive image" width="85%">
                <img src="IT/2.jpg" class="mySlides" alt="Responsive image" width="85%">
                <img src="IT/3.jpg" class="mySlides" alt="Responsive image" width="85%">
                <img src="IT/4.jpg" class="mySlides" alt="Responsive image" width="85%">
                <img src="IT/5.jpg" class="mySlides" alt="Responsive image" width="85%">
                <img src="IT/6.jpg" class="mySlides" alt="Responsive image" width="85%">
                <img src="IT/7.jpg" class="mySlides" alt="Responsive image" width="85%">
                <img src="IT/8.jpg" class="mySlides" alt="Responsive image" width="85%">
                <img src="IT/9.jpg" class="mySlides" alt="Responsive image" width="85%">
                <img src="IT/10.jpg" class="mySlides" alt="Responsive image" width="85%">
                <img src="IT/ICT.jpg" class="mySlides" alt="Responsive image" width="85%">
                </div>
