...
<div class="topnavs" id="myTopnavs">
    ...
    <div class="dropdowns">
      ...
      <div class="dropdowns-content">
       ...
       <a href="instructions.php">Instructions</a>v
    <div class="dropdowns">
        ...
        <div class="col-md-8 p-3">
          <div class="row" style="font-size: 25px;">
            <div class="row text-white p-3 mb-3" style="background: #093b24; font-family: 'Roboto', sans-serif;">
               <h1>University Quality Policy</h1>
            </div>
           <div class="p-3">
            <p>The Isabela State University endeavors to be A Lead University in Instruction, Research, Extension And Resource Generation through continuous improvement of services.</p>
            <p style="font-size: 20px;">1. To Uphold The Commitment, ISU Shall Attain The Following Quality Objectives:</p>  
            <p style="font-size: 20px;">2. Sustain Academic Excellence And Quality In Instruction;</p>
            <p style="font-size: 20px;">3. Generate Research Breakthroughs;</p>
            <p style="font-size: 20px;">4. Engage In Sectoral Activities For Community Development;</p>
            <p style="font-size: 20px;">5. Develop Products For Globalizations;</p>
            <p style="font-size: 20px;">6. Support Students Participation To Local And International For A To Enhance Their Potentialities;</p>
            <p style="font-size: 20px;">7. Comply With The Standards Set By Statutory, Regulatory And Accrediting Bodies And;</p>
            <p style="font-size: 20px;">8. Review On Periodic Basis, The Quality Management System (QMS)And Gather Feedbacks On The Level Of Client Satisfaction As Basis For Continuous Improvement.</p>
            <b><p style="font-size: 15px;">Revised As Per BOR Res. No.: 12, S. 2017</p></b>
